...
import edu.co.sena.pruebagit2.miappws.DomicilioProvee;
import edu.co.sena.pruebagit2.miappws.DomicilioProveePK;
 ...
 */
@Stateless
@Path("edu.co.sena.pruebagit2.miappws.domicilioprovee")
public class DomicilioProveeFacadeREST extends AbstractFacade<DomicilioProvee> {
    ...
    private DomicilioProveePK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        edu.co.sena.pruebagit2.miappws.DomicilioProveePK key = new edu.co.sena.pruebagit2.miappws.DomicilioProveePK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        edu.co.sena.pruebagit2.miappws.DomicilioProveePK key = getPrimaryKey(id);

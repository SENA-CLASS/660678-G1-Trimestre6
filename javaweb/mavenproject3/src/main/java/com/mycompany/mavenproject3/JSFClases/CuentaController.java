...
import com.mycompany.mavenproject3.sessionBeans.CuentaFacade;
...
public class CuentaController implements Serializable {
    ...
    @EJB
    private com.mycompany.mavenproject3.sessionBeans.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new com.mycompany.mavenproject3.CuentaPK());
    }
    ...
    public Cuenta getCuenta(com.mycompany.mavenproject3.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        com.mycompany.mavenproject3.CuentaPK getKey(String value) {
            com.mycompany.mavenproject3.CuentaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.mavenproject3.CuentaPK();
            key.setTipoDocumentoTipoDocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(com.mycompany.mavenproject3.CuentaPK value) {

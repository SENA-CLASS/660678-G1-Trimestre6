...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.mavenproject3.InventarioComprasPK[ idinventario=" + idinventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }

...
import com.mycompany.mavenproject3.sessionBeans.ItemFacade;
...
public class ItemController implements Serializable {
    ...
    @EJB
    private com.mycompany.mavenproject3.sessionBeans.ItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemPK(new com.mycompany.mavenproject3.ItemPK());
    }
    ...
    public Item getItem(com.mycompany.mavenproject3.ItemPK id) {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        com.mycompany.mavenproject3.ItemPK getKey(String value) {
            com.mycompany.mavenproject3.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.mavenproject3.ItemPK();
            key.setProductoIdProducto(values[0]);
            key.setPedidoFacturaIdFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.mycompany.mavenproject3.ItemPK value) {

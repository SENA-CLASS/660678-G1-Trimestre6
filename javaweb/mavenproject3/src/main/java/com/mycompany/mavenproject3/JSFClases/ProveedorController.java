...
import com.mycompany.mavenproject3.sessionBeans.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private com.mycompany.mavenproject3.sessionBeans.ProveedorFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setProveedorPK(new com.mycompany.mavenproject3.ProveedorPK());
    }
    ...
    public Proveedor getProveedor(com.mycompany.mavenproject3.ProveedorPK id) {
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        com.mycompany.mavenproject3.ProveedorPK getKey(String value) {
            com.mycompany.mavenproject3.ProveedorPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.mavenproject3.ProveedorPK();
            key.setTipoDocumentoTipoDocumento(values[0]);
            key.setNumDocumento(values[1]);
            return key;
        }

        String getStringKey(com.mycompany.mavenproject3.ProveedorPK value) {

...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private edu.co.sena.pruebagit2.ejemplo.ProveedorFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setProveedorPK(new edu.co.sena.pruebagit2.ejemplo.ProveedorPK());
    }
    ...
    public Proveedor getProveedor(edu.co.sena.pruebagit2.ejemplo.ProveedorPK id) {
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        edu.co.sena.pruebagit2.ejemplo.ProveedorPK getKey(String value) {
            edu.co.sena.pruebagit2.ejemplo.ProveedorPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.pruebagit2.ejemplo.ProveedorPK();
            key.setTipoDocumentoTipoDocumento(values[0]);
            key.setNumDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.pruebagit2.ejemplo.ProveedorPK value) {

...
public class DomicilioProveeController implements Serializable {
    ...
    @EJB
    private edu.co.sena.pruebagit2.ejemplo.DomicilioProveeFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setDomicilioProveePK(new edu.co.sena.pruebagit2.ejemplo.DomicilioProveePK());
    }
    ...
    public DomicilioProvee getDomicilioProvee(edu.co.sena.pruebagit2.ejemplo.DomicilioProveePK id) {
    ...
    public static class DomicilioProveeControllerConverter implements Converter {
        ...
        edu.co.sena.pruebagit2.ejemplo.DomicilioProveePK getKey(String value) {
            edu.co.sena.pruebagit2.ejemplo.DomicilioProveePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.pruebagit2.ejemplo.DomicilioProveePK();
            key.setProveedorTipoDocumentoTipoDocumento(values[0]);
            key.setProveedorNumDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.pruebagit2.ejemplo.DomicilioProveePK value) {

...
public class ItemController implements Serializable {
    ...
    @EJB
    private edu.co.sena.pruebagit2.ejemplo.ItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemPK(new edu.co.sena.pruebagit2.ejemplo.ItemPK());
    }
    ...
    public Item getItem(edu.co.sena.pruebagit2.ejemplo.ItemPK id) {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        edu.co.sena.pruebagit2.ejemplo.ItemPK getKey(String value) {
            edu.co.sena.pruebagit2.ejemplo.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.pruebagit2.ejemplo.ItemPK();
            key.setProductoIdProducto(values[0]);
            key.setPedidoFacturaIdFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(edu.co.sena.pruebagit2.ejemplo.ItemPK value) {

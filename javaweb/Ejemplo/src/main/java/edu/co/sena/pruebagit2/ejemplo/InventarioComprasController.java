...
public class InventarioComprasController implements Serializable {
    ...
    @EJB
    private edu.co.sena.pruebagit2.ejemplo.InventarioComprasFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setInventarioComprasPK(new edu.co.sena.pruebagit2.ejemplo.InventarioComprasPK());
    }
    ...
    public InventarioCompras getInventarioCompras(edu.co.sena.pruebagit2.ejemplo.InventarioComprasPK id) {
    ...
    public static class InventarioComprasControllerConverter implements Converter {
        ...
        edu.co.sena.pruebagit2.ejemplo.InventarioComprasPK getKey(String value) {
            edu.co.sena.pruebagit2.ejemplo.InventarioComprasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.pruebagit2.ejemplo.InventarioComprasPK();
        ...
        String getStringKey(edu.co.sena.pruebagit2.ejemplo.InventarioComprasPK value) {

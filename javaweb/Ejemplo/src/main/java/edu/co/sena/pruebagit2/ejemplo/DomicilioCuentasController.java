...
public class DomicilioCuentasController implements Serializable {
    ...
    @EJB
    private edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setDomicilioCuentasPK(new edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasPK());
    }
    ...
    public DomicilioCuentas getDomicilioCuentas(edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasPK id) {
    ...
    public static class DomicilioCuentasControllerConverter implements Converter {
        ...
        edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasPK getKey(String value) {
            edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasPK();
            key.setCuentaTipoDocumentoTipoDocumento(values[0]);
            key.setCuentaNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.pruebagit2.ejemplo.DomicilioCuentasPK value) {

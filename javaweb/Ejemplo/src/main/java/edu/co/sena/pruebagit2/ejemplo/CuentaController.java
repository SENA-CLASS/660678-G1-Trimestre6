...
public class CuentaController implements Serializable {
    ...
    @EJB
    private edu.co.sena.pruebagit2.ejemplo.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new edu.co.sena.pruebagit2.ejemplo.CuentaPK());
    }
    ...
    public Cuenta getCuenta(edu.co.sena.pruebagit2.ejemplo.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        edu.co.sena.pruebagit2.ejemplo.CuentaPK getKey(String value) {
            edu.co.sena.pruebagit2.ejemplo.CuentaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.pruebagit2.ejemplo.CuentaPK();
            key.setTipoDocumentoTipoDocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.pruebagit2.ejemplo.CuentaPK value) {

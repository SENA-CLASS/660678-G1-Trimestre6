...
import edu.co.sena.onlineshop.model.entities.DomicilioCuentas;
...
import edu.co.sena.onlineshop.contoller.administrador.beans.DomicilioCuentasFacade;
...
public class DomicilioCuentasController implements Serializable {
    ...
    @EJB
    private edu.co.sena.onlineshop.contoller.administrador.beans.DomicilioCuentasFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setDomicilioCuentasPK(new edu.co.sena.onlineshop.model.entities.DomicilioCuentasPK());
    }
    ...
    public DomicilioCuentas getDomicilioCuentas(edu.co.sena.onlineshop.model.entities.DomicilioCuentasPK id) {
    ...
    public static class DomicilioCuentasControllerConverter implements Converter {
        ...
        edu.co.sena.onlineshop.model.entities.DomicilioCuentasPK getKey(String value) {
            edu.co.sena.onlineshop.model.entities.DomicilioCuentasPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.onlineshop.model.entities.DomicilioCuentasPK();
            key.setCuentaTipoDocumentoTipoDocumento(values[0]);
            key.setCuentaNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.onlineshop.model.entities.DomicilioCuentasPK value) {

...
import edu.co.sena.onlineshop.contoller.administrador.beans.MunicipioFacade;
...
public class MunicipioController implements Serializable {
    ...
    @EJB
    private edu.co.sena.onlineshop.contoller.administrador.beans.MunicipioFacade ejbFacade;

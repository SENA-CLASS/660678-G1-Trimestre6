...
import edu.co.sena.onlineshop.contoller.administrador.beans.ItemFacade;
...
public class ItemController implements Serializable {
    ...
    @EJB
    private edu.co.sena.onlineshop.contoller.administrador.beans.ItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemPK(new edu.co.sena.onlineshop.model.entities.ItemPK());
    }
    ...
    public Item getItem(edu.co.sena.onlineshop.model.entities.ItemPK id) {
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        edu.co.sena.onlineshop.model.entities.ItemPK getKey(String value) {
            edu.co.sena.onlineshop.model.entities.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.onlineshop.model.entities.ItemPK();
            key.setProductoIdProducto(values[0]);
            key.setPedidoFacturaIdFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(edu.co.sena.onlineshop.model.entities.ItemPK value) {
